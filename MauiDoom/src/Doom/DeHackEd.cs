    ...
    public static class DeHackEd
    {
        ...
        private static void ReadFiles(params string[] fileNames)
        {
            ...
            try
            {
                ...
                System.Diagnostics.Debug.Write("Load DeHackEd patches: ");
                ...
                System.Diagnostics.Debug.WriteLine("OK (" + string.Join(", ", fileNames.Select(x => Path.GetFileName(x))) + ")");
            }
            catch (Exception e)
            {
        ...
        private static void ReadDeHackEdLump(Wad wad)
        {
            ...
            if (lump != -1)
            {
                ...
                try
                {
                    System.Diagnostics.Debug.Write("Load DeHackEd patch from WAD: ");
